 ...
 * Description: This class is responsible for the methods and attributes of a Beverage Vending 
 *              Machine.
 */
...
public class VendingMachine {
  ...
  public VendingMachine() {
    ...
    for (String teaName : TEA_NAMES) {
      Tea tea =
          new Tea(TEA_PRICES.get(teaName), teaName, TEA_DESC.get(teaName), TEA_LEAF.get(teaName));
      beverages.add(tea);
    }
    // add condiments
